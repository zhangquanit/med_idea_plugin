...
public class GitUtil {
    ...
    public static VirtualFile getVcsRoot(@NotNull final Project project, @NotNull final VirtualFile virtualFile) {
        ...
        for (VcsRoot vroot : vroots) {
            ...
            String rootpath = vroot.getPath().getPath();
            if (vpath.startsWith(rootpath))
                return vroot.getPath();
        }

        // best guess....
        return vroots[0].getPath();
    }
    ...
    public static File getDirectory(Project project) {
//        return VfsUtil.virtualToIoFile(vcsRoot);
        return new File(MedConfig.getRemoteConfigLibDir(project));
    }
}